 ...
 */
public class MinimaxNode implements MinimaxTree.TreePrintable {
     ...
     */
    public MinimaxNode(Grid grid, Mark minimax, GameState gameState , int depth) {
        this.grid=grid;
